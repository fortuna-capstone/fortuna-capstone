...
const tilemap = [
  ...
  [
    ...
    new Tile(' '),
    new Tile(' '),
    new Tile(1, 'Built a website for a local company! Collect $2,000 (Orange #8)', (scene, amount) => 
      collect(scene, (amount = 2000))
    ),
    new Tile(' '),
    new Tile(' '),
    ...
    new Tile(2, 'Life Tile #5', pickLifeTile),
    new Tile(' '),
    new Tile(1, 'You get a bonus! Collect $10,000! (Orange #9)', (scene, amount) => collect(scene, (amount = 10000))),
    new Tile(' '),
    new Tile(' '),
  ...
  [
    new Tile(1, 'Sell old computer equipment. Collect $3,000 (Orange #11)', (scene, amount) => 
      collect(scene, (amount = 3000))
    ),
    new Tile(0, 'Red Tile #2', pickCareer),
    new Tile(1, 'Sell old computer equipment. Collect $3,000 (Orange #11)', (scene, amount) => 
      collect(scene, (amount = 3000))
